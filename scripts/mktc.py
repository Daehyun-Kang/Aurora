...
AZTestCaseVectorStruct="az_tc_testvector_st"
AZTestCaseVectorArray="az_tc_testvector_array"
AZTestCaseVectorType="az_tc_tv"
...
def defTCInitHandler(f, fn):
  ...
  f.write("      xe = az_xml_element_find_attr(iter->xml, \"expected_result\");\n")
  f.write("      if (xe) tv->expected_result = strtol(xe->kv.value, NULL, 10);\n")
